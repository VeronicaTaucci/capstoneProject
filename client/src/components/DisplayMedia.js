                ...
                <ul>
                    {media.map((media) => {
                        switch (media.mediaFormat) {
                            ...
                            case 'audio':
                                return <figure>
                                    <figcaption>{media.createdAt}</figcaption> <audio controls key={media.id} src={media.mediaUrl}> Your browser does not support the <code>audio</code> element. </audio> </figure>
                            default:
                                break;
                        }
                        // return (
